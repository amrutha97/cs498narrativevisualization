...
async function load1() {
    d3.csv("https://flunky.github.io/cars2017.csv").then(function (data) {
        ...
        scene1.selectAll("mybar")
            ...
            .enter()
            .append("rect")
            .attr("x", function (d) { return makeScale(d.Make); })
...
// var shape = d3.scaleOrdinal().domain(keys_fuel).range([d3.symbolCircle(), d3.symbolDiamond(), d3.symbolStar()]);
